                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="contactLogado" class="nav-item nav-link">Contato</a>
                            </div>
                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="gerenciador.php">Pagina Inícial</a></li>
                            <li class="breadcrumb-item"><a href="contactLogado.php">Contato</a></li>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Reserve seu</h6>
                    <h1 class="mb-5"><span class="text-primary text-uppercase">Quarto de Luxo</span></h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="select2">Crianças</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <select class="form-select" id="select3">
                                                <option value="1">Quarto Jequitibá</option>
                                                <option value="2">Quarto Central</option>
                                                <option value="3">Quarto Quadra 8</option>
                                            </select>
                                            <label for="select3">Escolha um Quarto</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Special Request" id="message" style="height: 100px"></textarea>
                                            <label for="message">Pedidos ou Ajustes</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
