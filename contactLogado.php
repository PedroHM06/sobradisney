        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Entre Em Contato</h6>
                    <h1 class="mb-5"></span> De Qualquer Lugar</h1>
                </div>
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            <div class="col-md-4">
                                ...
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>Sobradisney@gmail.com</p>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <h6 class="section-title text-start text-primary text-uppercase">Reclamações</h6>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>Sobradisney@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        <iframe class="position-relative rounded w-100 h-100" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d7267.900951483298!2d-47.802439661128645!3d-15.655079096698937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1spt-BR!2sbr!4v1684773846903!5m2!1spt-BR!2sbr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>"
                        </iframe>
                    </div>
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Deixe sua mensagem aqui" id="messagem" style="height: 150px"></textarea>
                ...
                <div class="col-lg-10 border rounded p-1">
                    <div class="border rounded text-center p-1">
                        <div class="bg-white rounded text-center p-5">
                            <h4 class="mb-4">Deixe seu email para <span class="text-primary text-uppercase">Novidades</span>
                            </h4>
            ...
            <div class="container pb-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <h6 class="section-title text-start text-primary text-uppercase mb-4">Contato</h6>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Projeção de Sobradinho, Quadra 1</p>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="row gy-5 g-4">
                            <div class="col-md-6">
                                ...
                                <a class="btn btn-link" href="gerenciador.php">Sobre Nós</a>
                                <a class="btn btn-link" href="contactLogado.php">Converse Conosco</a>
                            </div>
                            <div class="col-md-6">
                                <h6 class="section-title text-start text-primary text-uppercase mb-4">Serviços</h6>
                                <a class="btn btn-link" href="gerenciador.php">All-NotInclusive</a>
                                <a class="btn btn-link" href="gerenciador.php">Spa & Fitness</a>
                                <a class="btn btn-link" href="gerenciador.php">Piscinas</a>
                                <a class="btn btn-link" href="gerenciador.php">Eventos & Festas</a>
                                <a class="btn btn-link" href="gerenciador.php">Academia</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Sobradisney</a>, All Right Reserved.
